...
indLayers = [37, 28, 19];   % The CNN layers Conv5-4, Conv4-4 in VGG Net
numLayers = length(indLayers);
new_hf_num_deep = cell(1,numLayers);        hf_den_deep = cell(1,numLayers);
new_hf_den_deep = cell(1,numLayers);        hf_num_deep = cell(1,numLayers);
new_hf_num_deep_can = cell(1,numLayers);    xtf_deep_can = cell(1,numLayers);
new_hf_den_deep_can = cell(1,numLayers);    xtf_deep = cell(1,numLayers);
